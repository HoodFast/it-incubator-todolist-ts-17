...
test("correct todolist should be added", () => {
  ...
  const endState = todolistsReducer(startState, todolistsActions.addTodolist({ todo: todolist }));
...
test("correct filter of todolist should be changed", () => {
  ...
  const action = todolistsActions.changeTodolistFilter({ todoId: todolistId2, filter: newFilter });
...
test("correct entity status of todolist should be changed", () => {
  ...
  const action = todolistsActions.changeTodolistEntityStatus({ todoId: todolistId2, entityStatus: newStatus });
